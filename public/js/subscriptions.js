var subscriptionTemplate = '<div class="col-xs-10 col-xs-offset-1"><div class="row subscription"><div class="col-xs-4"><img class="img-fluid" src="REPLACEIMAGELOC"></div><div class="col-xs-8"><div class="row"><div class="col-xs-4 showAllEpisodes"><h3>Show All Episodes</h3></div><div class="col-xs-4 markAllAsListened"><h3>Mark All As Listened</h3></div><div class="col-xs-4 deletePodcast"><h3>Delete Podcast</h3></div></div><div class="row"><h1>REPLACEPODCASTNAME</h1><ul></ul></div></div></div></div>'
